...
import com.titans.serialport.exception.ReadDataFromSerialPortFailure;
import com.titans.serialport.exception.SendDataToSerialPortFailure;
import com.titans.serialport.exception.SerialPortInputStreamCloseFailure;
import com.titans.serialport.exception.SerialPortOutputStreamCloseFailure;
	...
	public static SerialPort openPort(String portName, int baudrate)
		...
		try {
			...
			if (commPort instanceof SerialPort) {
				...
				// 不是串口
				JOptionPane.showMessageDialog(null, new NotASerialPort().toString(), "提示信息", JOptionPane.ERROR_MESSAGE);
